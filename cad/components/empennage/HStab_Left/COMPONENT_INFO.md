...
## Description
Left half of the all-moving horizontal stabilizer. Features a span-varying airfoil
blend from HT-14 (7.5%) at root to HT-13 (6.5%) at tip, with swept leading-edge
tip closure. Internal spar channels for 3mm pivot rod and 2mm rear spar.
...
## Build Script
`scripts/build_hstab_left.py` (Build123d, exports STEP + STL)

## Drawing
`HStab_Left_drawing.dxf` — 3-view technical drawing with internal structure
...
## Assembly
Part of `HStab_Assembly` (left half of all-moving horizontal stabilizer)
