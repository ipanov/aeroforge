# Wing_Panel_P3 -- Component Information

## Overview

Third panel of the right half-wing (Panel 3 of 5). Span station
512-768mm from wing root. The left wing uses a mirrored copy
...
| Parameter | Value |
|-----------|-------|
| **Span station** | 512 - 768mm (from wing root) |
| **Span** | 256mm (exact Bambu bed fit) |
| **Root chord** | 198mm (at P2/P3 joint) |
| **Outboard chord** | 186mm (at P3/P4 joint) |
| **Root airfoil** | 80% AG24 / 20% AG03 blend |
| **Outboard airfoil** | 55% AG24 / 45% AG03 blend |
| **Twist** | -0.4 deg (root) to -1.1 deg (outboard) |
| **Dihedral** | 0.0 deg (inboard face) / 1.5 deg (outboard face) |
...
| **Joint (outboard)** | Male tongue 3.0mm, 2mm deep. 1.5 deg dihedral |
...
| **Flap chord** | 55mm (root) to 52mm (outboard) |
...
| **Position** | Mid-panel (y=640mm), 35% chord |
| **Drives** | P3 flap via direct pushrod |
...
| **Bed usage** | 256mm x 198mm (fits 256x256 bed) |
...
- Drawing: `Wing_Panel_P3_drawing.dxf` / `.png`
