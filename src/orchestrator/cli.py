...
def main() -> None:
    ...
    p_init.add_argument("--top-object", default="Aircraft", help="Top assembly or object name")
    p_init.add_argument("--project-code", default="PRJ1", help="Project family code")
    p_init.add_argument("--current-round", default="R1", help="Current round label")
    p_init.add_argument("--next-round", default="R2", help="Next round label")
    ...
    p_start_legacy.add_argument("--project-code", default="PRJ1")
    ...
    p_start_profile.add_argument("--project-code", default="PRJ1")
