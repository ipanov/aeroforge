...
def main():
    doc = setup_drawing(
        title="Elevator_Right",
        subtitle="Right elevator ONLY (hinge face to TE). Bull-nose concealed saddle. Right = mirror.",
    ...
    msp.add_text("ELEVATOR SHELL (RIGHT)", height=3.5,
    ...
    for sy, ys, lab in [
        ...
        # Offset so hinge face is at SX (right edge of section)
        ...
        # Hinge face (right edge of elevator section — where bull-nose is)
        yu_h = upper_pts[0][1]
        yl_h = lower_pts[0][1]
    ...
    save_dxf_and_png(doc, "cad/components/empennage/Elevator_Right/Elevator_Right_drawing.dxf", dpi=300)
    print("Elevator_Right v6 done — ELEVATOR ONLY, real airfoil sections.")
